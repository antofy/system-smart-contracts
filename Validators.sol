...
contract Validators is Params {
    ...
    uint256 public totalRewardOut;
    uint256 private constant rewardAmount = 0.1 ether;
    ...
    function initialize(address[] calldata vals) external payable onlyNotInitialized {
        ...
        onlyInitialized
    {
        ...
        if(totalRewardOut + rewardAmount <= maxReward ){
            payable(val).transfer(rewardAmount);
            totalRewardOut += rewardAmount;
        }
        //to validator
